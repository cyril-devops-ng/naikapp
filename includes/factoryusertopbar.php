        ...
        <ul class="dropdown-menu extended notification">
          ...
          <?php 
                foreach( $_SESSION['requestlist'] as $k=>$v){
                    if($v['status'] == 'Approved'){
                        ++$request_count;
                        echo '<li> <a href="processrequest#"'.$v['request_no'].'"> <span class="label label-success"><i class="icon-plus"></i></span> <span class="message">Request for '.$v['quantity'].' bags  of '.$v['stock_name'].' from '.$v['sales_area'].'.</span> <span class="time">1 mins</span> </a> </li>';
                    }
                }

            ?>
          <li class="footer"> <a href="processrequest">View all stock movement requests</a> </li>
        </ul>
...
<!--      <li class="dropdown"> <a data-toggle="dropdown" class="dropdown-toggle" href="#"> <i class="icon-envelope"></i> <span class="badge">3</span> </a>
      ...
      <li class="dropdown user  hidden-xs"> <a data-toggle="dropdown" class="dropdown-toggle" href="#"> <i class="icon-male"></i> <span class="username"><?php echo $_SESSION['user']['fullname']?></span> <i class="icon-caret-down small"></i> </a>
        <ul class="dropdown-menu">
          <li><a href="factoryuserprofile"><i class="icon-user"></i> My Profile</a></li>
          <li class="divider"></li>
