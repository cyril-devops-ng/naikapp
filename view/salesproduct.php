                        ...
                        <div class="col-lg-12">
                            <div class="widget">
                                ...
                                <div class="widget-content" style="font-size:22px;">
                                    ...
                                    <p style="font-size:22px;">Report Title:Product Sales Report</p>
                                ...
                                <div class="widget">
                                    ...
                                    <div class="widget-content" >
                                        <ul class="nav nav-tabs" id="myTab" >
                                            <li class="active"><a data-toggle="tab" href="#layers"><span style="font-size: 22px;">PRODUCTS</span></a></li>
                                        </ul>
