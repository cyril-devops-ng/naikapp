...
<html>
    ...
    <head>
        <title>NAIK FEEDS Change Password</title>
                            ...
                            <div class="widget">
                                ...
                                <div class="widget-content" >
                                    ...
                                    <div class="panel-body" >
                                        <center><img src="img/ppelogo.png" width="250px" height="250px" align="top|left"/><h2>Change Password</h2></center>
                                        <form action="changepassword" method="post" class="form-horizontal row-border" />

                                        <div class="form-group lable-padd">
                                            <label class="col-sm-3">Old Password:</label>
                                            <div class="col-sm-6">
                                                <input type="password" class="form-control" placeholder="Old Password" name="oldpass" id="oldpass" required />
                                            </div>
                                        ...
                                        <div class="form-group lable-padd">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="password" class="form-control" placeholder="Confirm New Password" name="confpass" id="confpass" required/>
                                            </div>
