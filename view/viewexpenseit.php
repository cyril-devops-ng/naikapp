          ...
          <div class="widget">
            ...
            <div class="widget-content">
              <div class="body">
                  ...
                  <form method="post" action="viewexpenseit">
                  Month: 
...
<script type="text/javascript">
    $(document).ready(function(){
        $('body').on('click','.edit',function(){
            var id = $(this).attr('id');
            $.post('viewexpenseit',{edit:true,id:id},function(msg,stat,xhr){
                if(xhr.readyState === 4){
                    if(xhr.status === 200){
        ...
        $('body').on('click','.delete',function(){
            ...
            if(confirm("Are you sure you want to delete?")){
                $.post('viewexpenseit',{delete:true,id:id},function(msg,stat,xhr){
