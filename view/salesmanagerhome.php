...
<div class="wrapper">
  ...
  <div class="page-content">
    <div class="content container">
      <div class="row">
        <div class="col-lg-12">
          <h2 class="page-title">SALES MANAGER <small>Dashboard</small></h2>
        </div>
      </div>
      <div class="row">
          <?php 
//            print '<pre>'; print_r($_SESSION); print '</pre>';
            foreach($_SESSION['all_naik_customers'] as $k=>$v){
                if($v['sales_area'] == $_SESSION['user']['sales_area'] && $v['customer_category'] == 'Credit Depot'){
                    ++$count;
                }
             }
             ...
             foreach($_SESSION['admin_sales'] as $k=>$v){
                if($v['trans_type'] == 'Credit' && $v['sales_area'] == $_SESSION['user']['sales_area']){
                    ...
                    $credittotal += floatval(str_replace(',', '', $v['total_price']));
                }
            }
            ...
            foreach($_SESSION['admin_sales'] as $k=>$v){
                if($v['trans_type'] == 'Cash' && $v['sales_area'] == $_SESSION['user']['sales_area']){
                    ...
                    $cashtotal += floatval(str_replace(',', '', $v['total_price']));
                }
            }
            
            
            foreach($_SESSION['stock_value'] as $k=>$v){
                if($v['sales_area'] == $_SESSION['user']['sales_area']){
                    $subtotal += ( floatval(str_replace(',', '', $v['selling_price'])) * floatVal($v['quantity']) );
                    $total += $subtotal;
                }
        ...
        <div class="col-md-12">
          <div class="row">
            <div class="col-md-3 col-xs-12 col-sm-6"> <a href="#" class="stats-container">
              <div class="stats-heading">Credit Sales</div>
              <div class="stats-body-alt"> 
               
                <div class="text-center"><span class="text-top">&#8358 </span><?= number_format($credittotal) ?></div>
                <small>Pending Returns</small> </div>
              <div class="stats-footer">Pending Credit Sales</div>
              </a> </div>
            <div class="col-md-3 col-xs-12 col-sm-6"> <a href="#" class="stats-container">
              <div class="stats-heading">Cash Sales</div>
              <div class="stats-body-alt"> 
               
                <div class="text-center"><span class="text-top">&#8358 </span><?= number_format($cashtotal) ?></div>
                <small>Sales for this month</small> </div>
              <div class="stats-footer">All sales for this month</div>
              </a> </div>
            <div class="col-md-3 col-xs-12 col-sm-6"> <a href="#" class="stats-container">
              <div class="stats-heading">Credit Depots</div>
              <div class="stats-body-alt"> 
               
                <div class="text-center"><span class="text-top"></span><?= $count ?></div>
                <small>Credit Depots</small> </div>
              <div class="stats-footer">My Credit Depots</div>
              </a> </div>
            <div class="col-md-3 col-xs-12 col-sm-6"> <a href="#" class="stats-container">
              ...
              <div class="stats-body-alt"> 
                ...
                <small>Stock Value</small> </div>
              <div class="stats-footer">Stock Balance</div>
              </a> </div>
          </div>
        </div>
      </div>
