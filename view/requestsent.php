...
<div class="wrapper">
  ...
  <div class="page-content">
    <div class="content container">
      <div class="row">
        <div class="col-lg-12">
          <h2 class="page-title">Request Completed<small></small></h2>
        </div>
      </div>
      <div class="row">
        <div class="alert alert-success alert-block fade in">
                    ...
                    <p>You have successfully requested for stock.<br/><br/>Your request is being processed!<br/><br/>View your stock request list 
                    to track request status!</p>
                  </div>
      </div>
