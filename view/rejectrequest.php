...
<html>
    ...
    <head>
        <title>NAIK FEEDS Rejected Request List</title>
                                                ...
                                                <table class="table table-striped display" id="example">
                                                    <thead>
                                                        <tr style="font-size:20px;">
                                                            ...
                                                            <th class="hidden-xs">Reject Reason</th>
                                                    ...
                                                    <tbody> 
                                                        ...
                                                        foreach ($_SESSION['requestlist'] as $k => $v) {
                                                            if ($v['status'] == 'Rejected') {
                                                                $img = '<img src="img/rejected.png" width="40px" height="30px">&nbsp;';
                                                                $i+=1;
                                                                echo '<tr>';
                                                                echo '<td>' . $i . '</td>';
