...
<html>
    ...
    <head>
        <title>NAIK FEEDS Create Raw Material Stock</title>
                            ...
                            <div class="widget">
                                ...
                                <div class="widget-content">
                                    <div class="panel-body">
                                        ...
                                        <form id="rmform" action="createrm" method="post" class="form-horizontal row-border" />
                                        <?php 
//                                            print'<pre>';
                                                ...
                                                <select name="stocktype" class="form-control" id="stocktype" required>
                                                    ...
                                                    <?php
                                                        echo '<option>--Select--</option>';
                                                                echo '<option value="Raw Materials">Raw Materials</option>';
