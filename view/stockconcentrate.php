                                                ...
                                                <table class="table table-striped table-images display" id="example">
                                                    ...
                                                    <tbody id="tableBody">
                                                        ...
                                                        foreach ($_SESSION['stockconcentrate'] as $k => $v) {
                                                            ...
                                                            '<td>' . $m[intval($mth) - 1] . '</td>' .
                                                            '<td class="hidden-xs">' . explode('-', $v['upload_date'])[2] . '-' . explode('-', $v['upload_date'])[1] . '-' . explode('-', $v['upload_date'])[0] . '</td>' .
                                                            '<td class="hidden-xs">' .
                                                            '<button data-toggle="button" class="btn btn-sm btn-primary edit" id="' . $v['stock_id'] . '"> Edit </button>' .
                                                            '<button data-toggle="button" class="btn btn-sm btn-warning delete" id="' . $v['stock_id'] . '"> Delete </button></td>';
                                                            '</tr>';
                                                        }
                                                        ?>
                                                    </tbody>
