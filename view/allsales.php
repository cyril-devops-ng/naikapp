                                    ...
                                    <table class="table table-striped table-images">
                                        ...
                                        <tbody>
                                             <tr>
                                                ...
                                                <td>625503</td>
                                                <td>EZE FEEDS</td>
                                                <td class="hidden-xs">Jos</td>
                                                <td class="hidden-xs">2016-05-29</td>
                                                <td class="hidden-xs">Not Complete</td>
                                                <td class="hidden-xs"><button class="btn btn-success remit">REMIT</button></td>
                                            </tr>
