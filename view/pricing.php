...
<html>
    ...
    <head>
        <title>NAIK FEEDS Maintain Pricing</title>
                        ...
                        <div class="col-lg-12">
                            <div class="widget">
                                <div class="widget-header"> <i class="icon-file-alt"></i>
                                    <h3><?= isset($edit) && $edit == true ? "Edit Price":"New Price" ?></h3>
                                </div>
                                <div class="widget-content">
                                    <div class="panel-body">
                                        <center><img src="img/price-logo.jpg" width="250px" height="250px" align="top|left"/><h2><?= isset($edit) && $edit == true ? "Edit Price":"Add New Price" ?></h2></center>
                                        <form id="priceform" action="pricing" method="post" class="form-horizontal row-border" />
                                        <?php 
//                                            print'<pre>';
...
<!--                                        <div class="form-group lable-padd">
                                        ...
                                        <div class="form-group lable-padd">
                                            ...
                                            <div class="col-sm-6">
                                                <input id="sellprice" value='<?= $_SESSION['edit_stock'][0]['selling_price'] ?>' type="text" name="sellprice" class="form-control mask" data-inputmask="'mask':'N 999,999,999.99', 'greedy' : false, 'rightAlignNumerics' : false" required/>
                                            </div>
                                            <div class="col-sm-3 left-align">
                                                <p class="help-block"></p>
                                            </div>
                                        ...
                                        <div class="form-actions">
                                            <div>
                                                <button id="addUserBtn" class="btn btn-primary" type="submit"><?= isset($edit) && $edit == true ? "Save":"Add Price" ?></button>
