...
<html>
    ...
    <head>
        <title>NAIK FEEDS Raw Material List</title>
                                                ...
                                                <div id="demo">
                                                    <table class="table table-striped display" id="example">
                                                        ...
                                                        <tbody> 
                                                            ...
                                                            $m = explode(',',$month);
                                                            foreach ($_SESSION['raw_material_list'] as $k => $v) {
                                                                $i+=1;
...
//                                                                echo '<td>' . number_format($v['cost_price']) . '</td>';
                                                                echo '<td>' . number_format($v['cost_price']!=''?$v['cost_price']:0) . '</td>';
