...
<div class="wrapper">
  ...
  <div class="page-content">
    <div class="content container">
      <div class="row">
        <div class="col-lg-12">
          <h2 class="page-title">IT ADMINISTRATOR <small>Home</small></h2>
        </div>
      </div>
      <div class="row">
        <div class="col-md-12">
          <div class="row">
            <div class="col-md-3 col-xs-12 col-sm-6"> <a href="createsales" class="stats-container">
              <div class="stats-heading">Sales</div>
              <div class="stats-body-alt"> 
               
                <div class="text-center"><span class="text-top">CREATE</div>
                <small>Sales Document</small> </div>
              <div class="stats-footer"></div>
              </a> </div>
            
            <div class="col-md-3 col-xs-12 col-sm-6"> <a href="maintaincustomers" class="stats-container">
              <div class="stats-heading">Customers</div>
              <div class="stats-body-alt"> 
               
                <div class="text-center"><span class="text-top">CREATE</span></div>
                <small>Customers</small> </div>
              <div class="stats-footer"></div>
              </a> </div>
<!--            <div class="col-md-3 col-xs-12 col-sm-6"> <a href="stockrequest" class="stats-container">
              <div class="stats-heading">STOCK</div>
              <div class="stats-body-alt"> 
             
                <div class="text-center"><span class="text-top">REQUEST</span></div>
                <small>Form</small> </div>
              <div class="stats-footer"></div>
              </a> </div>-->
              <div class="col-md-3 col-xs-12 col-sm-6"> <a href="stockmovement" class="stats-container">
              <div class="stats-heading">Track</div>
              <div class="stats-body-alt"> 
               
                <div class="text-center"><span class="text-top">STOCK</span></div>
                <small>Requests</small> </div>
              <div class="stats-footer"></div>
              </a> </div>
          </div>
        </div>
      ...
      <?php
        ...
        $query = mysqli_query($c,"select * from stocks where `sales_area` like '%".$_SESSION['user']['sales_area']."%'");
     ...
     <div class="row">
        <div class="col-md-12">
          <div class="row">
            <div class="col-md-3 col-xs-12 col-sm-6"> <a href="createstock" class="stats-container">
              <div class="stats-heading">Stock</div>
              <div class="stats-body-alt"> 
               
                <div class="text-center"><span class="text-top">CREATE</div>
                <small>Stock</small> </div>
              <div class="stats-footer"></div>
              </a> </div>
            <div class="col-md-3 col-xs-12 col-sm-6"> <a href="itadminstock" class="stats-container">
              <div class="stats-heading">My Stock</div>
              <div class="stats-body-alt"> 
               
                <div class="text-center"><span class="text-top"><?= $check ?></span></div>
                <small>Stock</small> </div>
              <div class="stats-footer"></div>
              </a> </div>
            <div class="col-md-3 col-xs-12 col-sm-6"> <a href="transferstock" class="stats-container">
              <div class="stats-heading">Stock</div>
              <div class="stats-body-alt"> 
               
                <div class="text-center"><span class="text-top">TRANSFER</span></div>
                <small>Routine</small> </div>
              <div class="stats-footer"></div>
              </a> </div>
<!--            <div class="col-md-3 col-xs-12 col-sm-6"> <a href="processrequest" class="stats-container">
              <div class="stats-heading">Stock</div>
              <div class="stats-body-alt"> 
               
                <div class="text-center"><span class="text-top">PROCESS REQUEST</span></div>
                <small>Stock</small> </div>
              <div class="stats-footer"></div>
              </a> </div>-->
        ...
        <div class="col-md-12">
          <div class="row">
            <div class="col-md-3 col-xs-12 col-sm-6"> <a href="creditreturns" class="stats-container">
              <div class="stats-heading">Cash Pickup</div>
              <div class="stats-body-alt"> 
               
                <div class="text-center"><span class="text-top">CASH PICK UP</div>
                <small>Sales Outlet</small> </div>
              <div class="stats-footer"></div>
              </a> </div>
              
              
              
            <div class="col-md-3 col-xs-12 col-sm-6"> <a href="viewstock" class="stats-container">
              <div class="stats-heading">Stock</div>
              <div class="stats-body-alt"> 
               
                <div class="text-center"><span class="text-top">PRODUCED STOCK</div>
                <small>Produced</small> </div>
              <div class="stats-footer"></div>
              </a> </div>
            <div class="col-md-3 col-xs-12 col-sm-6"> <a href="stocklist" class="stats-container">
              <div class="stats-heading">Stock</div>
              <div class="stats-body-alt"> 
               
                <div class="text-center"><span class="text-top">SALES AREA STOCK</div>
                <small>Sales Area Stock</small> </div>
              <div class="stats-footer"></div>
              </a> </div>
