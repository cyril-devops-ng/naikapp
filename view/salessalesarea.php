...
<html>
    ...
    <head>
        ...
        <link href="style/dashboard.css" rel="stylesheet"> <link href="css/demo_page.css" rel="stylesheet">
                        ...
                        <div class="col-lg-12">
                            <div class="widget">
                                ...
                                <div class="widget-content" style="font-size:22px;">
                                    ...
                                    <p style="font-size:22px;">Report Title: Sales Area Report</p>
                                ...
                                <div class="widget">
                                    ...
                                    <div class="widget-content">
                                        <ul class="nav nav-tabs" id="myTab">
                                            <li class="active"><a data-toggle="tab" href="#abuja"><span style="font-size: 22px;">ABUJA</span></a></li>
                                            <li class=""><a data-toggle="tab" href="#jos"><span style="font-size: 22px;">JOS</span></a></li>
                                            <li class=""><a data-toggle="tab" href="#lagos"><span style="font-size: 22px;">LAGOS</span></a></li>
                                        </ul>
                                        <div class="tab-content" id="myTabContent">
                                            <?php // print'<pre>'; print_r($_SESSION['all_naik_customers']); print '</pre>'; ?>
                                            <div id="jos" class="tab-pane fade ">
                                                <table class="table table-striped table-bordered" id="josArea">
                                                    <thead>
                                                        <tr>
                                                            <th>#</th>
...
//                                           print '<pre>'
                                                        foreach ($_SESSION['admin_sales'] as $k => $v) {
                                                            if ($v['sales_area'] == 'Jos') {
                                                                ...
                                                                $d =  explode(' ',$date)[0] ;
                                                                $mth = explode('-',$d)[1];
                                                                foreach ($_SESSION['all_naik_customers'] as $a => $b) {
                                                                    if ($v['cust_id'] == $b['cust_id']) {
                                            ...
                                            <div id="abuja" class="tab-pane fade active in">
                                                <table class="table table-striped table-bordered" id="abujaArea">
                                                    <thead>
                                                        <tr>
                                                            <th>#</th>
                                                            <th class="hidden-xs">Customer Name</th>
                                            ...
                                            <div id="lagos" class="tab-pane fade ">
                                                <table class="table table-striped table-bordered" id="lagosArea">
                                                    <thead>
                                                        <tr>
                                                            <th>#</th>
                                                            <th class="hidden-xs">Customer Name</th>
                                                ...
                                                <!--<p style="font-size:22px;text-align: right;">Total: &#8358 <?= number_format($lagostotal) ?></p>-->
                                            </div>
                                        </div>
                                    </div>
                                </div>
