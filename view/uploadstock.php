...
<html>
    ...
    <head>
        <title>NAIK FEEDS Upload Stock</title>
                            ...
                            <div class="widget">
                                ...
                                <div class="widget-content">
                                    <div class="panel-body">
                                        <center><img src="img/upload.png" width="250px" height="250px" align="top|left"/><h2>Upload New Stock</h2></center>
                                        <form action="uploadstock" method="post" class="form-horizontal row-border" enctype="multipart/form-data" />
                                        <input type="hidden" name="uploadFile" value="upload" />
                                        <div class="form-group lable-padd">
                                            <label class="col-sm-3">File Name:</label>
                                            <div class="col-sm-6">
                                                <input type="file" class="form-control btn" placeholder="Stock Upload File name" name="stockName" id="stock" required />
                                            </div>
                                        ...
                                        <div class="form-actions">
                                            <div>
                                                <button id="addUserBtn" class="btn btn-primary" type="submit">Upload</button>
                                                <button id="clearBtn" class="btn btn-default" type="button">Reset</button>
                                            </div>
                                        </div>
                                        </form>
                                    </div>
