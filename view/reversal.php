...
<html>
    ...
    <head>
        <title>NAIK FEEDS Reversal</title>
                        ...
                        <div class="col-lg-12">
                            <div class="widget">
                                <div class="widget-header"> <i class="icon-file-alt"></i>
                                    <h3><?= isset($edit) && $edit == true ? "Reverse Stock":"Reverse Stock" ?></h3>
                                </div>
                                <div class="widget-content">
                                    <div class="panel-body">
                                        <center><img src="img/rev.png" width="250px" height="250px" align="top|left"/><h2><?= isset($edit) && $edit == true ? "Reverse Stock":"Reverse Stock" ?></h2></center>
                                        <form id="reverseForm" action="reversal" method="post" class="form-horizontal row-border" />
                                        <?php 
//                                            print'<pre>';
...
//                                                                echo '<option value="Raw Materials">Raw Materials(KG)</option>';
                                                            ...
                                                            case 'Complete Feed':
                                                                ...
                                                                echo '<option value="Raw Materials" selected>Complete Feed(BAG)</option>';
//                                                                echo '<option value="Raw Materials" >Raw Materials(KG)</option>';
                                                                break; 
                                                            case 'Raw Materials': 
                                                                echo '<option>--Select--</option>';
...
<!--                                        <div class="form-group lable-padd">
                                        ...
                                        <div class="form-group lable-padd">
                                            <label class="col-sm-3">Quantity</label>
                                            <div class="col-sm-6">
                                              <input  type="number" name="quantity" class="form-control mask" data-inputmask="'mask':'N 999,999,999.99', 'greedy' : false, 'rightAlignNumerics' : false" required/>
                                            </div>
                                            <div class="col-sm-3 left-align">
                                                <p class="help-block"></p>
                                            </div>
                                        ...
                                        <div class="form-actions">
                                            <div>
                                                <button id="addUserBtn" class="btn btn-primary" type="submit"><?= isset($edit) && $edit == true ? "Reverse":"Reverse" ?></button>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                $('#priceform').submit(function(){
                    ...
                    if(error > 0){
                        alert('Some Mandatory Fields have not been entered!');
                        return false;
                    }else{
                        return true;
                    }
