...
<head>
<title>NAIK FEEDS FACTORY STOCK MOVEMENT</title>
...
<div class="wrapper">
  ...
  <div class="page-content">
    <div class="content container">
      <div class="row">
        <div class="col-lg-12">
          <h2 class="page-title">IT ADMINISTRATOR <small>Stock Movement</small></h2>
        </div>
      </div>
      <div class="row">
        <div class="col-md-12">
...
<!--            <div class="col-md-3 col-xs-12 col-sm-6"> <a href="processrequest" class="stats-container">
              ...
              <div class="stats-body-alt"> 
                ...
                <div class="text-center"><span class="text-top">PROCESS REQUEST</div>
