                        ...
                        <div class="col-lg-12">
                            <div class="widget">
                                <div class="widget-header"> <i class="icon-table"></i>
                                    <h3>PROFIT BY CUSTOMER REPORT</h3>
                                </div>
                                <div class="widget-content" style="font-size:22px;">
                                    ...
                                    <p style="font-size:22px;">Report Title: Profit By Customer Report</p>
...
<!--                                    <form method="post" action=""/>
                                ...
                                <div class="widget-header"> <i class="icon-arrow-down"></i>
                                    <h3>CLICK ON THE CUSTOMER CATEGORY TAB </h3>
                                </div>
                                <div class="widget-content">
                                  <ul class="nav nav-tabs" id="myTab">
                                      <li class="active"><a data-toggle="tab" href="#cash"><span style="font-size: 22px;">CASH</span></a></li>
                                      <li class=""><a data-toggle="tab" href="#credit"><span style="font-size: 22px;">CREDIT</span></a></li>
                                  </ul>
                                  <div class="tab-content" id="myTabContent">
                                    ...
                                    <div id="credit" class="tab-pane fade ">
                                        <table class="table table-striped table-bordered display" id="credittable">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th>Customer Name</th>
