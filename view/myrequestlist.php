...
<html>
    ...
    <head>
        <title>NAIK FEEDS Request List</title>
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($_SESSION['requestlist'] as $k => $v) {
                                                if($v['status'] == 'Rejected'){
                                                        $img = '<img src="img/rejected.png" width="60px" height="30px">&nbsp;';
                                                    }
                                                    if($v['status'] == 'Pending'){
                                                        $img = '<img src="img/pending.png" width="60px" height="30px">&nbsp;';
                                                    }
                                                    if($v['status'] == 'Approved'){
                                                        $img = '<img src="img/approved.png" width="60px" height="30px">&nbsp;';
                                                    }
                                                    if($v['status'] == 'In Transit'){
                                                        $img = '<img src="img/transit.png" width="60px" height="30px">&nbsp;';
                                                    }
                                                    if($v['status'] == 'Completed'){
                                                        $img = '<img src="img/complete.png" width="60px" height="30px">&nbsp;';
                                                    }
                                                $i+=1;
                                                echo '<tr>';
                                                echo '<td>' . $i . '</td>';
                                                ...
                                                if($v['status'] == 'Pending'){
                                                        ...
                                                        echo '<td class="hidden-xs"><button class="btn btn-sm btn-primary view" id="' . $v['request_no'] . '"> View Details </button>&nbsp;' ;
                                               }
